                ...
                {data ? (
                    data.map(({ id, type, screeningStart, price, movie }) => (
                        <li key={id} className="mb-10 ms-4">
                            ...
                            <time className="mb-2s text-md font-normal leading-none text-gray-400 dark:text-gray-500">
                                {format(new Date(screeningStart), "MMMM dd, yyyy '-' HH:mm aa")}
                            </time>
                            <h3 className="mb-1 text-xl font-semibold text-gray-900 dark:text-white">{movie.title}</h3>
                            <p className="text-sm line-clamp-2 font-normal text-gray-500 dark:text-gray-400">
                                {movie.description}
                            </p>
                            <p className="text-sm line-clamp-2 font-normal text-gray-500 dark:text-gray-400">
                                Type: {type}
                            </p>
                            <p className="mb-4 text-sm line-clamp-2 font-normal text-gray-500 dark:text-gray-400">
